...
/// Fonction qui initialise les differentes variable de notre ville
t_ville* init_ville()
{
...
/// Fonction qui initialise notre matrice de case 60x26
...
/// Initialise la matrice d'outil pour la bar a outil
