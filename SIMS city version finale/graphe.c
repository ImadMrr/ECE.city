...
/**
    ...
    Toutes les procedures en rapport avec la théorie des graphes
    ont ete tirees des fonctions de bases utilisées lors des tp de debut d'annee

    elles ont toutes ete adaptees en matrice afin de faciliter les calculs et la liaison avec l'affichage

**/

/// Fonction de creatio du graphe
Graphe* CreerGraphe()
{
...
/// Fonction de creation des arretes du graphe
...
/// Fonction qui reutilise les 2 fonctions precedente pour creer un graphe correspondant a nos attentes
...
/// Fonction qui initalise les differentes variables du graphe
